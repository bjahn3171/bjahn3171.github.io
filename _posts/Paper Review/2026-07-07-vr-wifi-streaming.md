...
<figure class="paper-figure paper-figure--wide">
  <img src="{{ '/assets/images/paper_review/vr-wifi/vr_server_model.png' | relative_url }}" alt="VR Wi-Fi streaming framework overview">
</figure>
...
<figure class="paper-figure paper-figure--wide">
  <img src="{{ '/assets/images/paper_review/vr-wifi/vr_cloud_model.png' | relative_url }}" alt="VR Wi-Fi streaming framework overview">
</figure>
